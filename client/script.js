...
const request = () => {
    axios.get('http://localhost:3000/query-test/?name=clay&age=30')
    .then(res => {
        console.log(res)
    })
    .catch(err => {
...
/*
    ...
    Got an error message stating that we sent no query.
...
const addFood = document.querySelector('#add-button')
